...
//representado por um **!** (ponto de exclamação). Ele consiste em realizar a multiplicação de todos 
//os números (a partir de 1) até aquele colocado na operação. Veja os exemplos abaixo:
...
//Anagrama é uma outra palavra (não precisa existir em português) com as mesmas letras da anterior em 
//ordem diferentes. Por exemplo, anagramas da palavra `mesa` são: `ames`, `maes`, `meas`, `emsa`, `smea` 
//e muitos outros.
